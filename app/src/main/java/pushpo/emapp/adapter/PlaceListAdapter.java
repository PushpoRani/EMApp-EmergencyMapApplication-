...
import pushpo.emapp.activity.PlaceDetailActivity;
...
private ArrayList<Place> distanceBetweenTwoPlace = new ArrayList<>();
...
//                mNearByPlaceArrayList.get(mItemPosition).getPlaceLongitude()) / 1000;
        ...
        String distanceBetweenTwoPlace = String.valueOf(mNearByPlaceArrayList.get(position).getDistance());
