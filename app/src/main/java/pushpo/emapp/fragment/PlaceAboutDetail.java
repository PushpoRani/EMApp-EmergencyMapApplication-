...
import pushpo.emapp.maputils.AboutMapUtils;
...
public class PlaceAboutDetail extends Fragment implements OnMapReadyCallback{
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        //aboutMapUtils = new AboutMapUtils(PlaceAboutDetail.this, mGoogleMap);
...
//        final LatLng current = new LatLng(Double.valueOf(currentPlace[0])
//                , Double.valueOf(currentPlace[1]));
//        final LatLng target = new LatLng(mCurrentPlace.getPlaceLatitude(),mCurrentPlace.getPlaceLongitude());
        ...
        //aboutMapUtils.getDirectionOnMap(current, target);




    //direction line code from here.....
